...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler
    private ResponseEntity<Object> exception(Exception e, WebRequest request) {
        e.printStackTrace();
    ...
    public ResponseEntity onThrowException(GeneralExcpetion generalExcpetion, HttpServletRequest request) {
        ErrorReasonDTO errorReasonHttpStatus = generalExcpetion.getErrorReasonHttpStatus();
        return handleExceptionInternal(generalExcpetion, errorReasonHttpStatus, null, request);
    }
